...
class AuthorsRegisterTest(AuthorsBaseTest):
    ...
    def test_user_valid_data_register_successfully(self):
        ...
        self.get_by_placeholder(form, "Seu email").send_keys("email@valid.com")
        self.get_by_placeholder(form, "Digite sua senha").send_keys("P@ssw0rd1")
        self.get_by_placeholder(form, "Repita sua senha").send_keys("P@ssw0rd1")
        sleep(5)
        form.submit()
